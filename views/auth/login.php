<div class="md:w-1/2 px-5">
        ...
        <form class="mt-6" action="<?= atlas('login') ?>" method="POST">
          <div>
        ...
        <div class="text-sm flex justify-between items-center mt-3">
          ...
          <a href="<?= atlas('signup') ?>" class="w-250 block bg-gray-400 hover:bg-gray-200 focus:bg-gray-400 text-white font-semibold rounded-sm px-4 py-3 mt-6 text-center">Join the horde</a>
        </div>
      </div>
